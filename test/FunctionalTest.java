...
public class FunctionalTest {
    ...
    public void redirectHomePage() {
        Result result = Helpers.route(application, Home2Controller.index());
    ...
    public void listComputersOnTheFirstPage() {
        Result result =  Helpers.route(application, Home2Controller.list(0, "name", "asc", ""));
    ...
    public void filterComputerByName() {
        Result result = Helpers.route(application, Home2Controller.list(0, "name", "asc", "Apple"));
    ...
    public void createANewComputer() {
        Result result = Helpers.route(application, Home2Controller.save());
        ...
        String saveUrl = Home2Controller.save().url();
        ...
        result = Helpers.route(application, Home2Controller.list(0, "name", "asc", "FooBar"));
        assertThat(result.status(), equalTo(Helpers.OK));
